        ...
        <div class="main-container container-fluid">
            ...
            <div style="display:flex;gap:20px;margin-bottom:25px;">
                ...
                <div style="flex:1;background:#fff;border:1px solid #e2e8f0;padding:20px;border-radius:8px;">
                    ...
                    <div id="smsServiceStatus" style="margin-top:15px;font-weight:600;
            ...
            <div style="background:#fff;border:1px solid #e2e8f0;border-radius:8px;">
                ...
                <div style="padding:25px;">
                    ...
                    <div style="margin-top:25px;padding:20px;border:1px solid #e2e8f0;border-radius:8px;background:#f8fafc;">
                        ...
                        <div style="margin-top:15px;">
                            ...
                            <select id="typeInput" class="form-control mt-2">
                                <option value="text" {{ isset($smsSetting) && $smsSetting->type == 'text' ? 'selected' : '' }}>Text Message</option>
                                <option value="unicode" {{ isset($smsSetting) && $smsSetting->type == 'unicode' ? 'selected' : '' }}>Unicode (বাংলা)</option>
                            </select>
                        </div>
                        ...
                        <div style="margin-top:20px;padding:15px;background:#fff;border-radius:8px;border:1px solid #e2e8f0;">
                            ...
                            <div style="display:flex;flex-wrap:wrap;gap:10px;" id="tagList">
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('order_number')">
                                    <code>{order_number}</code> - Order Number
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('customer_name')">
                                    <code>{customer_name}</code> - Customer Name
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('customer_phone')">
                                    <code>{customer_phone}</code> - Customer Phone
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('status')">
                                    <code>{status}</code> - Status (English)
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('bangla_status')">
                                    <code>{bangla_status}</code> - Status (বাংলা)
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('company')">
                                    <code>{company}</code> - Company Name
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('order_date')">
                                    <code>{order_date}</code> - Order Date
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('total_amount')">
                                    <code>{total_amount}</code> - Total Amount
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('payment_method')">
                                    <code>{payment_method}</code> - Payment Method
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="insertTag('delivery_address')">
                        ...
                        <div style="margin-top:20px;">
                            <ul class="nav nav-tabs" id="templateTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="btn btn-sm btn-success ml-2" onclick="showAddTemplateModal()" style="margin-left: 10px;">
                            ...
                            <div class="tab-content" style="margin-top:20px;">
                                ...
                                <div class="tab-pane active" id="pending">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('pending')">
                                ...
                                <div class="tab-pane fade" id="processing">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('processing')">
                                        <i class="fas fa-eye"></i> Preview Message
                                    </button>
                                </div>
                                ...
                                <div class="tab-pane fade" id="shipped">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('shipped')">
                                        <i class="fas fa-eye"></i> Preview Message
                                    </button>
                                </div>
                                ...
                                <div class="tab-pane fade" id="delivered">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('delivered')">
                                        <i class="fas fa-eye"></i> Preview Message
                                    </button>
                                </div>
                                ...
                                <div class="tab-pane fade" id="completed">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('completed')">
                                        <i class="fas fa-eye"></i> Preview Message
                                    </button>
                                </div>
                                ...
                                <div class="tab-pane fade" id="cancelled">
                                    ...
                                    <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('cancelled')">
                                        <i class="fas fa-eye"></i> Preview Message
                                    </button>
                                </div>
                                ...
                                <div id="dynamicTemplatesContainer">
                                    @foreach($templates as $status => $template)
                                        ...
                                        <div class="tab-pane fade" id="dynamic_{{ $status }}">
                                            <label>{{ ucfirst(str_replace('_', ' ', $status)) }} Status Message Template</label>
                                            ...
                                            <button type="button" class="btn btn-sm btn-info mt-2" onclick="previewMessage('{{ $status }}')">
                                                <i class="fas fa-eye"></i> Preview Message
                                            </button>
                                            <button type="button" class="btn btn-sm btn-danger mt-2 ml-2" onclick="deleteTemplate('{{ $status }}')">
                        ...
                        <div style="margin-top:20px;padding:15px;background:#fff3cd;border-radius:8px;">
                            ...
                            <small class="text-muted">⚠️ This template will be used if no status-specific template is found</small>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Use lowercase and underscore (_) instead of space</small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('order_number')">
                                                {order_number}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('customer_name')">
                                                {customer_name}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('customer_phone')">
                                                {customer_phone}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('status')">
                                                {status}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('bangla_status')">
                                                {bangla_status}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('company')">
                                                {company}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('order_date')">
                                                {order_date}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('total_amount')">
                                                {total_amount}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('payment_method')">
                                                {payment_method}
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-secondary mb-1" onclick="insertTagInModal('delivery_address')">
                                                {delivery_address}
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="addNewTemplate()">Add Template</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="previewModal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div style="background:#e5e5ea;padding:20px;border-radius:10px;margin-bottom:15px;">
                                        <div style="background:#fff;padding:15px;border-radius:10px;">
                                            <div style="font-size:14px;color:#8e8e93;margin-bottom:5px;">Message Preview</div>
                                            <div id="previewMessage" style="font-size:16px;line-height:1.5;word-wrap:break-word;"></div>
                                        </div>
                                    </div>
...
$(document).ready(function() {
    $('#updateSmsConfig').click(function() {
        ...
        let templates = {
            pending: $('#pendingTemplate').val(),
            processing: $('#processingTemplate').val(),
            shipped: $('#shippedTemplate').val(),
            delivered: $('#deliveredTemplate').val(),
            completed: $('#completedTemplate').val(),
            cancelled: $('#cancelledTemplate').val(),
            default: $('#defaultTemplate').val()
        };
