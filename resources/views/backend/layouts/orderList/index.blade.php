                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0">Purchase Id</th>
...
<script>
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.inapp.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function deleteItem(id) {
        NProgress.start();
        let url = "{{ route('admin.inapp.destroy', ':id') }}";
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.inapp.show', ':id') }}";
