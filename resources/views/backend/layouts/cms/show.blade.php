        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header d-flex align-items-center justify-content-between">
                    <h1 class="page-title">CMS: {{ ucwords(str_replace('_', ' ', $page ?? '')) }} -
                        {{ ucwords(str_replace('_', ' ', $section ?? '')) }}</h1>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset(!empty($data->image) && file_exists(public_path($data->image)) ? $data->image : 'default/logo.png') }}"
                                                class="img-preview" alt="Background Image" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Button</th>
                                        <td>
                                            <button onclick="window.open('{{ $data->btn_link ?? '#' }}')"
                                                class="btn btn-custom btn-outline-primary">{{ $data->btn_text ?? 'No Button Text' }}</button>
                                        </td>
                                    </tr>
