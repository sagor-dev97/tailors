...
Route::controller(RedmeeCodeController::class)->group(function () {
    Route::get('/get-redeem', 'getRedeem');
});


Route::controller(SendInvitationController::class)->group(function () {
    Route::post('/send-invitation', 'sendInvitation');
    Route::post('/share-prompt', 'shareInvitation');
});
Route::controller(GetPhoneNumberController::class)->group(function () {
    Route::get('/user-phonenumber', 'getUserPhone');
    Route::get('/get-shared-reedme', 'getSharedRedeem');
    Route::get('/get-shared-prompts', 'getSharedRedeemUsers');
    Route::get('/shared-question-answer', 'getPromptQuestionsAnswered');

    Route::post('/check-number', 'checkAndInvitePhones');
});


Route::controller(QuestionController::class)->group(function () {
    Route::get('/get-question', 'getQuestion');
    Route::post('/submit-answer', 'submitAnswer');
    Route::get('/get-answer', 'getQuestionAnswer');
    Route::get('/get-answered-questions', 'getAnsweredQuestionsByCategory');

    Route::delete('answer/file/delete', 'deleteAnswerFile');
});
Route::post('/check-reedme-code', [CheckRedmeeCodeController::class, 'checkCode']);
Route::post('/purchase', [InAppPurchaseController::class, 'store']);
